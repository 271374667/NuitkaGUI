...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.horizontalLayout_3.addWidget(self.btnModifyingPythonPaths)
        ...
        self.gridLayout.addWidget(self.lePythonPath, 1, 1, 1, 1)
...
"-show-memory", None))
        self.btnModifyingPythonPaths.setText(QCoreApplication.translate("MainWindow", u"\u4fee\u6539Python\u8def\u5f84", None))
        self.lePythonPath.setPlaceholderText(QCoreApplication.translate("MainWindow", u"\u5f53\u524d\u7684Python\u8def\u5f84\u672a\u521d\u59cb\u5316\uff01", None))
        self.btnSetIcon.setText(QCoreApplication.translate("MainWindow", u"\u8bbe\u7f6e\u56fe\u6807", None))
        self.lineEdit.setPlaceholderText(QCoreApplication.translate("MainWindow", u"\u8fd9\u91cc\u653e\u7f6e\u56fe\u6807\uff0c\u53ef\u4ee5\u76f4\u63a5\u62d6\u5165", None))
        self.btnSetOutputPath.setText(QCoreApplication.translate("MainWindow", u"\u8bbe\u7f6e\u8f93\u51fa\u8def\u5f84", None))
        self.lineEdit_2.setPlaceholderText(QCoreApplication.translate("MainWindow", u"\u5728\u8fd9\u91cc\u8bbe\u7f6e\u8f93\u51fa\u8def\u5f84\uff0c\u53ef\u4ee5\u4f7f\u7528\u62d6\u62fd\u7684\u65b9\u5f0f", None))
...
"\n"
"\u8fd9\u6837\u505a\u80fd\u591f\u8ba9\u4f60\u66f4\u5feb\u7684\u7f16\u8bd1\uff0c\u800c\u4e14\u6709\u7684\u65f6\u5019\u5982\u679c\u4f60\u6ca1\u6709\u5f00\u542f\u63d2\u4ef6\u6700\u540e\u751a\u81f3\u53ef\u80fd\u65e0\u6cd5\u8fd0\u884c\uff0c\u6bd4\u5982PyQt", None))
...
#endif // QT_CONFIG(whatsthis)
        self.cbDisableCcache.setText(QCoreApplication.translate("MainWindow", u"\u6e05\u9664\u4e0a\u4e00\u6b21\u7684\u7f13\u5b58\uff0c\u9632\u6b62\u6253\u5305\u5931\u8d25\n"
"disable-ccache", None))
#if QT_CONFIG(tooltip)
...
#endif // QT_CONFIG(whatsthis)
        self.cbNoFollowImports.setText(QCoreApplication.translate("MainWindow", u"\u4e0d\u5bfc\u5165\u4efb\u4f55\u6a21\u5757(\u4e0d\u9002\u5408\u5355\u6587\u4ef6)\n"
...
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(whatsthis)
        self.cbIncludeDataFiles.setWhatsThis(QCoreApplication.translate("MainWindow", u"<html><head/><body><p>\u5bf9\u4e8e\u8981\u5305\u542b\u7684\u6570\u636e\u6587\u4ef6\uff0c\u8bf7\u4f7f\u7528\u9009\u9879 --include-data-files=&lt;source&gt;=&lt;target&gt; \uff0c\u5176\u4e2d\u6e90\u662f\u6587\u4ef6\u7cfb\u7edf\u8def\u5f84\uff0c\u4f46\u5fc5\u987b\u6307\u5b9a\u76f8\u5bf9\u76ee\u6807\u3002\u5bf9\u4e8e\u72ec\u7acb\uff0c\u60a8\u4e5f\u53ef\u4ee5\u624b\u52a8\u590d\u5236\u5b83\u4eec\uff0c\u4f46\u8fd9\u53ef\u4ee5\u8fdb\u884c\u989d\u5916\u7684\u68c0\u67e5\uff0c\u5bf9\u4e8e\u5355\u6587\u4ef6\u6a21\u5f0f\uff0c\u65e0\u6cd5\u624b\u52a8\u590d\u5236\u3002</p><p>\u8981\u590d\u5236\u76ee\u5f55\u4e2d\u7684\u90e8\u5206\u6216\u5168\u90e8\u6587\u4ef6\uff0c\u8bf7\u4f7f\u7528\u9009\u9879 --include-data-files=/etc/*.txt=etc/ \uff0c\u60a8\u53ef\u4ee5\u5728\u5176\u4e2d\u6307\u5b9a\u6587\u4ef6\u7684 shell \u6a21\u5f0f\uff0c\u4ee5\u53ca\u653e\u7f6e\u5b83\u4eec\u7684\u5b50\u76ee\u5f55\uff0c\u7531\u5c3e\u90e8\u659c\u6760\u6307\u793a\u3002</p></body></html>", None))
#endif // QT_CONFIG(whatsthis)
        self.cbIncludeDataFiles.setText(QCoreApplication.translate("MainWindow", u"\u6253\u5305\u989d\u5916\u7684\u6587\u4ef6\n"
"--include-data-files", None))
#if QT_CONFIG(tooltip)
        self.cbIncludeDataDir.setToolTip(QCoreApplication.translate("MainWindow", u"include-data-dir", None))
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(whatsthis)
        self.cbIncludeDataDir.setWhatsThis(QCoreApplication.translate("MainWindow", u"\u8981\u590d\u5236\u5305\u542b\u6240\u6709\u6587\u4ef6\u7684\u6574\u4e2a\u6587\u4ef6\u5939\uff0c\u60a8\u53ef\u4ee5\u4f7f\u7528 --include-data-dir=/path/to/images=images \uff0c\u5b83\u5c06\u590d\u5236\u6240\u6709\u6587\u4ef6\uff0c\u5305\u62ec\u6f5c\u5728\u7684\u5b50\u76ee\u5f55\u7ed3\u6784\u3002\u60a8\u4e0d\u80fd\u5728\u6b64\u5904\u8fc7\u6ee4\uff0c\u5373\u5982\u679c\u60a8\u53ea\u60f3\u8981\u90e8\u5206\u526f\u672c\uff0c\u8bf7\u4e8b\u5148\u5220\u9664\u6587\u4ef6\u3002", None))
#endif // QT_CONFIG(whatsthis)
        self.cbIncludeDataDir.setText(QCoreApplication.translate("MainWindow", u"\u6253\u5305\u989d\u5916\u7684\u6587\u4ef6\u5939\u4ee5\u53ca\u6587\u4ef6\u5939\u4e0b\u6240\u6709\u7684\u5185\u5bb9\n"
...
"--quiet", None))
#if QT_CONFIG(tooltip)
        self.lineEditIncludeDataFiles.setToolTip(QCoreApplication.translate("MainWindow", u"\u8be5\u63a7\u4ef6\u6709\u66f4\u8be6\u7ec6\u7684\u8bf4\u660e\uff0c\u8bf7\u70b9\u51fb\u53f3\u4e0a\u89d2\u7684\u5c0f\u56fe\u6807\u518d\u70b9\u51fb\u8fd9\u91cc", None))
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(whatsthis)
        self.lineEditIncludeDataFiles.setWhatsThis(QCoreApplication.translate("MainWindow", u"<html><head/><body><p>\u53ef\u4ee5\u901a\u8fc7/path/to/file/*.txt\u7684\u5f62\u5f0f\u83b7\u53d6\u591a\u4e2a\u6587\u4ef6</p><p>\u540c\u6837\u4e5f\u53ef\u4ee5\u901a\u8fc7\u62d6\u62fd\u7684\u5f62\u5f0f\u53ea\u6253\u5305\u4e00\u4e2a\u6587\u4ef6</p><p>\u5982\u679c\u662f\u591a\u6587\u4ef6\u6253\u5305\u63a8\u8350\u5c3d\u91cf\u4e0d\u8981\u6253\u5305\u6570\u636e\u6587\u4ef6\uff0c\u5728\u8fd0\u884c\u4e4b\u540e\u518d\u624b\u52a8\u653e\u5165\u6570\u636e\u6587\u4ef6</p><p><br/></p></body></html>", None))
#endif // QT_CONFIG(whatsthis)
        self.lineEditIncludeDataFiles.setPlaceholderText(QCoreApplication.translate("MainWindow", u"\u989d\u5916\u7684\u6587\u4ef6(\u53ef\u4ee5\u8fdb\u5165WhatThis\u6a21\u5f0f\u67e5\u770b\u8be6\u7ec6\u8bf4\u660e)", None))
#if QT_CONFIG(tooltip)
        self.lineEditIncludeDataDir.setToolTip(QCoreApplication.translate("MainWindow", u"\u8be5\u63a7\u4ef6\u6709\u66f4\u8be6\u7ec6\u7684\u8bf4\u660e\uff0c\u8bf7\u70b9\u51fb\u53f3\u4e0a\u89d2\u7684\u5c0f\u56fe\u6807\u518d\u70b9\u51fb\u8fd9\u91cc", None))
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(whatsthis)
        self.lineEditIncludeDataDir.setWhatsThis(QCoreApplication.translate("MainWindow", u"\u53ef\u4ee5\u62d6\u62fd\uff0c\u8be5\u9009\u9879\u4f1a\u6253\u5305\u6587\u4ef6\u5939\u4e0b\u7684\u6240\u6709\u5185\u5bb9", None))
#endif // QT_CONFIG(whatsthis)
        self.lineEditIncludeDataDir.setText("")
        self.lineEditIncludeDataDir.setPlaceholderText(QCoreApplication.translate("MainWindow", u"\u989d\u5916\u7684\u6587\u4ef6\u5939\u4ee5\u53ca\u6587\u4ef6\u5939\u4e0b\u6240\u6709\u7684\u5185\u5bb9", None))
#if QT_CONFIG(tooltip)
        self.lineEditCompanyName.setToolTip(QCoreApplication.translate("MainWindow", u"\u5728\u53ef\u6267\u884c\u6587\u4ef6\u7684\u7248\u672c\u4fe1\u606f\u4e2d\u6dfb\u52a0\u516c\u53f8\u540d\u79f0\u3002", None))
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(whatsthis)
        self.lineEditCompanyName.setWhatsThis(QCoreApplication.translate("MainWindow", u"\u5728\u53ef\u6267\u884c\u6587\u4ef6\u7684\u7248\u672c\u4fe1\u606f\u4e2d\u6dfb\u52a0\u516c\u53f8\u540d\u79f0\u3002", None))
#endif // QT_CONFIG(whatsthis)
        self.lineEditCompanyName.setPlaceholderText(QCoreApplication.translate("MainWindow", u"windows-company-name", None))
#if QT_CONFIG(tooltip)
        self.lineEditFileVersion.setToolTip(QCoreApplication.translate("MainWindow", u"\u5728\u53ef\u6267\u884c\u6587\u4ef6\u7684\u7248\u672c\u4fe1\u606f\u4e2d\u6dfb\u52a0\u6587\u4ef6\u7248\u672c\u3002", None))
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(whatsthis)
        self.lineEditFileVersion.setWhatsThis(QCoreApplication.translate("MainWindow", u"<html><head/><body><p>\u5728\u53ef\u6267\u884c\u6587\u4ef6\u7684\u7248\u672c\u4fe1\u606f\u4e2d\u6dfb\u52a0\u6587\u4ef6\u7248\u672c\u3002</p><p>\u6ce8\u610f\u7248\u672c\u53f7\u5fc5\u987b\u8981\u6709\u56db\u4e2a\u6570\u5b57\uff0c\u6bd4\u59821.0.0.0</p><p><br/></p></body></html>", None))
#endif // QT_CONFIG(whatsthis)
        self.lineEditFileVersion.setPlaceholderText(QCoreApplication.translate("MainWindow", u"windows-file-version(\u5fc5\u987b\u662f4\u4f4d\u6570,\u6bd4\u59821.0.0.0)", None))
#if QT_CONFIG(tooltip)
        self.lineEditProductVersion.setToolTip(QCoreApplication.translate("MainWindow", u"\u5728\u53ef\u6267\u884c\u6587\u4ef6\u7684\u7248\u672c\u4fe1\u606f\u4e2d\u6dfb\u52a0\u4ea7\u54c1\u7248\u672c\u3002", None))
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(whatsthis)
        self.lineEditProductVersion.setWhatsThis(QCoreApplication.translate("MainWindow", u"<html><head/><body><p>\u5728\u53ef\u6267\u884c\u6587\u4ef6\u7684\u7248\u672c\u4fe1\u606f\u4e2d\u6dfb\u52a0\u4ea7\u54c1\u7248\u672c\u3002</p><p>\u6ce8\u610f\u7248\u672c\u53f7\u5fc5\u987b\u8981\u6709\u56db\u4e2a\u6570\u5b57\uff0c\u6bd4\u59821.0.0.0</p><p><br/></p></body></html>", None))
#endif // QT_CONFIG(whatsthis)
        self.lineEditProductVersion.setPlaceholderText(QCoreApplication.translate("MainWindow", u"windows-product-version(\u5fc5\u987b\u662f4\u4f4d\u6570,\u6bd4\u59821.0.0.0)", None))
#if QT_CONFIG(tooltip)
        self.lineEditFileDescription.setToolTip(QCoreApplication.translate("MainWindow", u"\u5728\u53ef\u6267\u884c\u6587\u4ef6\u7684\u7248\u672c\u4fe1\u606f\u4e2d\u6dfb\u52a0\u6587\u4ef6\u63cf\u8ff0\u3002", None))
#endif // QT_CONFIG(tooltip)
#if QT_CONFIG(whatsthis)
        self.lineEditFileDescription.setWhatsThis(QCoreApplication.translate("MainWindow", u"\u5728\u53ef\u6267\u884c\u6587\u4ef6\u7684\u7248\u672c\u4fe1\u606f\u4e2d\u6dfb\u52a0\u6587\u4ef6\u63cf\u8ff0\u3002", None))
#endif // QT_CONFIG(whatsthis)
        self.lineEditFileDescription.setPlaceholderText(QCoreApplication.translate("MainWindow", u"windows-file-description", None))
